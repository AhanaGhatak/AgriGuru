...
translated_soils = {_(soil): soil for soil in soil_crop_map.keys()}
soil_input_translated = st.selectbox(_("🧪 Select Soil Type for ML"), list(translated_soils.keys()))
soil_input = translated_soils[soil_input_translated]
